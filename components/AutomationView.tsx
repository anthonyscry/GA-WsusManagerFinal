...
const AutomationView: React.FC = () => {
  ...
  // Fix: Wrapped the unsubscribe cleanup function to ensure it returns void.
  // Set.delete returns a boolean which is not a valid return type for useEffect cleanup.
  useEffect(() => {
